...
2. Download the [script_init.bash](https://github.com/diogovalentte/arr-scripts/blob/main/lidarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/diogovalentte/arr-scripts/main/lidarr/scripts_init.bash)) and place it into the following folder:
   `/custom-cont-init.d`
